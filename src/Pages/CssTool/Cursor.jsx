...
export const Cursor = () => {
    ...
    useEffect(() => {
        document.title="CSS Cursor Generator";
      }, []);
            ...
            <div className="detail-hero">
                ...
                <div className="detail-hero-content">
                    <div className="detail-hero-content-heading">
                        <h1>CSS Cursor Generator
                        </h1>
                    </div>
                    <div className="detail-hero-content-des">
                        <p>Generate CSS Cursor with our generator tool. Preview the result and copy the generated code to your website.
                        </p>
                    </div>
                ...
                <div className='screen-preview'>
                    ...
                    <div className='screen-preview-box'>
                        <div className='screen-preview-box-sample' style={{ 'overflow': 'hidden' }}>
                            <div style={{ 'cursor': `${cursor}`, 'width': '350px', 'height': '150px', 'background': 'skyblue' }}>
