...
export const ListStyleGen = () => {

    const [type, setType] = useState('')
    const [position, setPosition] = useState('')

    useEffect(() => {
        document.title="CSS List Style Generator";
      }, []);
            ...
            <div className="detail-hero">
                ...
                <div className="detail-hero-content">
                    <div className="detail-hero-content-heading">
                        <h1>CSS List Style Generator
                        </h1>
                    </div>
                    <div className="detail-hero-content-des">
                        <p>Generate CSS List Style with our generator tool. Preview the result and copy the generated code to your website.
                        </p>
                    </div>
            ...
            <div className='screen'>
                ...
                <div className='screen-preview'>
                    ...
                    <div className='screen-preview-code'>
                        <code className='element-code'> list-style : {type} {position};</code>
