    ...
    return (
        <div>
            <div className="detail-hero">
                ...
                <div className="detail-hero-content">
                    ...
                    <div className="detail-hero-content-des">
                        <p>Generate Columns with our generator tool. Preview the result and copy the generated code to your website.</p>
                    </div>
            ...
            <div className='uppscreen'>
                ...
                <div className='screen' style={{'minHeight':'20vh', 'width':'100%','background':'none','margin':'0px'}}>
                    <div className='screen-editor'>
                        <h1>Options</h1>

                        <div className='screen-editor-color'>
                            <label>Horizontal Length</label>
                            <input id="horizontal" type="range" min="1" max="8" step={'1'} onChange={(e) => setCount(e.target.value)} value={count} />
                            <code>{count} </code>
                        </div>
                ...
                <div className='screen-preview' style={{ 'width': '100%', 'padding':'20px', 'marginTop':'-70px' }}>
                    <h1>Preview</h1>
