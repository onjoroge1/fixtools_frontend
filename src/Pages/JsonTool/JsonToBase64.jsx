...
export default function JsonToBase64() {
    ...
    const handleSubmit = async (e) => {
        ...
        await axios.post('https://onlinetoolbackend.herokuapp.com/api/jsontobase64', data)
            .then(response => {
        ...
        <div className="detail-hero" style={{ 'minHeight': '320px', 'maxHeight': '320px' }}>
            ...
            <div className="detail-hero-content">
                <div className="detail-hero-content-heading">
                    <h1>JSON To Base64 Generator
                    </h1>
                </div>
                <div className="detail-hero-content-des">
                    <p>Generate JSON To Base64 with our generator tool. Preview the result and copy the generated code to your website.
