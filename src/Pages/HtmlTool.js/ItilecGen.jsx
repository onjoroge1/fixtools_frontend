...
export const Italic = () => {
    ...
    useEffect(() => {
        document.title="HTML Italic Generator";
      }, []);
            ...
            <div className="detail-hero">
                ...
                <div className="detail-hero-content">
                    <div className="detail-hero-content-heading">
                        <h1>HTML Italic Generator

                        </h1>
                    </div>
                    <div className="detail-hero-content-des">
                        <p>Generate HTML Italic with our generator tool. Preview the result and copy the generated code to your website.
