...
export const HtmlCitation = () => {


    useEffect(() => {
        document.title="HTML Citation Generator";
      }, []);
            ...
            <div className="detail-hero">
                ...
                <div className="detail-hero-content">
                    <div className="detail-hero-content-heading">
                        <h1>HTML Citation Generator

                        </h1>
                    </div>
                    <div className="detail-hero-content-des">
                        <p>Generate HTML Citation with our generator tool. Preview the result and copy the generated code to your website.
