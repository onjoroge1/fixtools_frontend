...
export default function CsvToJson() {
    ...
    useEffect(() => {
        document.title = "CSV To JSON Generator"
    }, [])
    ...
    const handleSubmit = async (e) => {
        ...
        await axios.post('https://onlinetoolbackend.herokuapp.com/api/csvtojson', data)
            .then(response => {
        ...
        <div className="detail-hero" style={{ 'minHeight': '320px', 'maxHeight': '320px' }}>
            ...
            <div className="detail-hero-content">
                <div className="detail-hero-content-heading">
                    <h1>CSV To JSON Generator
                    </h1>
                </div>
                <div className="detail-hero-content-des">
                    <p>Generate CSV To JSON with our  generator tool. Preview the result and copy the generated code to your website.
                    </p>
                </div>
        ...
        <div className="tools-for-better-thinking" style={{ padding: '5rem 0px 5rem 0px' }}>
            <div className="container d-flex align-items-center justify-content-center row col-md-8">
                <div className="col-md-12 col-lg-12 offset-lg-6">
                    <label className="my-1 mr-2"><h2>Input CSV</h2></label>
