...
export default function XmlToJson() {
    ...
    const handleSubmit = async (e) => {
        ...
        await axios.post('https://fixtoolupdateninenovember.herokuapp.com/api/xmltojson', data)
            .then(response => {
                if (response.data === "") {
    ...
    return (<div>
        <div className="detail-hero" style={{ 'minHeight': '320px', 'maxHeight': '320px' }}>
            ...
            <div className="detail-hero-content">
                <div className="detail-hero-content-heading">
                    <h1>XML To JSON Generator
                    </h1>
                </div>
                <div className="detail-hero-content-des">
                    <p> Generate XML To JSON with our  generator tool. Preview the result and copy the generated code to your website.
                    </p>
                </div>
        ...
        <div className="container d-flex align-items-center justify-content-center row col-md-8">
            <div className="col-md-12 col-lg-12 offset-lg-6">
                <label className="my-1 mr-2"><h2>Input XML</h2></label>
