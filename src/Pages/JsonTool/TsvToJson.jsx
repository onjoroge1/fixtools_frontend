...
export default function TsvToJson() {
    ...
    useEffect(() => {
        document.title = "TSV To JSON Generator"
    }, [])
    ...
    const handleSubmit = async (e) => {
        ...
        await axios.post('https://onlinetoolbackend.herokuapp.com/api/tsvtojson', data)
            .then(response => {
    ...
    return (<div>
        <div className="detail-hero" style={{ 'minHeight': '320px', 'maxHeight': '320px' }}>
            ...
            <div className="detail-hero-content">
                <div className="detail-hero-content-heading">
                    <h1>TSV To JSON Generator
                    </h1>
                </div>
                <div className="detail-hero-content-des">
                    <p>Generate TSV To JSON with our generator tool. Preview the result and copy the generated code to your website.
                    </p>
                </div>
        ...
        <div className="container d-flex align-items-center justify-content-center row col-md-8">
            <div className="col-md-12 col-lg-12 offset-lg-6">
                <label className="my-1 mr-2"><h2>Input TSV</h2></label>
