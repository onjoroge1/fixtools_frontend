...
export const Bold = () => {
    ...
    useEffect(() => {
        document.title="HTML Bold Generator";
      }, []);
            ...
            <div className="detail-hero">
                ...
                <div className="detail-hero-content">
                    <div className="detail-hero-content-heading">
                        <h1>HTML Bold Generator

                        </h1>
                    </div>
                    <div className="detail-hero-content-des">
                        <p>Generate HTML Bold with our generator tool. Preview the result and copy the generated code to your website.
                        </p>
                    </div>
