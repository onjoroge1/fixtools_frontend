            ...
            <div className="detail-hero">
                ...
                <div className="detail-hero-content">
                    ...
                    <div className="detail-hero-content-des">
                        <p>Generate Html Iframe with our generator tool. Preview the result and copy the generated code to your website.
            ...
            <div className='screen'>
                <div className='screen-editor'>
                    ...
                    <div className='screen-editor-color'>
                        ...
                        <input placeholder='User image' onChange={(e) => setDescription(e.target.value)} />
                    </div>
                    <div className='screen-editor-color'>
                        <label>Width</label>
                ...
                <div className='screen-preview'>
                    ...
                    <div className='screen-preview-box'>
                        <div className='screen-preview-box-sample' style={{ 'overflow': 'hidden' }}>
                            <div style={{ 'width': '100%' }}>
                                <iframe src={position} title={description} style={{ 'width': `${width}px`, 'height': `${height}px` }} ></iframe>
                            </div>
                        </div>
                    </div>
                    <h1>Code</h1>
