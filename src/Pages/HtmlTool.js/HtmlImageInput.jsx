            ...
            <div className="detail-hero">
                ...
                <div className="detail-hero-content">
                    ...
                    <div className="detail-hero-content-des">
                        <p>Generate HTML Image Input with our generator tool. Preview the result and copy the generated code to your website.
            ...
            <div className='screen'>
                <div className='screen-editor'>
                    ...
                    <div className='screen-editor-color'>
                        ...
                        <input placeholder='20px' type={'number'} onChange={(e) => setWidth(e.target.value)} />
                    </div>
                    <div className='screen-editor-color'>
                        <label>Height (px)</label>
                        <input placeholder='30px' type={'number'} onChange={(e) => setHeight(e.target.value)} />
                    </div>
                ...
                <div className='screen-preview'>
                    ...
                    <div className='screen-preview-box'>
                        <div className='screen-preview-box-sample' style={{ 'overflow': 'hidden' }}>
                            <div style={{ 'width': '100%' }}>
                                <input type="image" src={position} aria-labelledby="" alt='' height={height} width={width} required={required} />
                            </div>
                        </div>
                    </div>
                    <h1>Code</h1>
