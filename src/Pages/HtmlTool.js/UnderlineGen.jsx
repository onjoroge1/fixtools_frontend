...
export const Underline = () => {
    ...
    useEffect(() => {
        document.title="HTML Underline Generator";
      }, []);
            ...
            <div className="detail-hero">
                ...
                <div className="detail-hero-content">
                    <div className="detail-hero-content-heading">
                        <h1>HTML Underline Generator

                        </h1>
                    </div>
                    <div className="detail-hero-content-des">
                        <p>Generate HTML Underline with our generator tool. Preview the result and copy the generated code to your website.
