...
export default function JsonToYaml() {
    ...
    const handleSubmit = async (e) => {
        ...
        await axios.post('https://onlinetoolbackend.herokuapp.com/api/jsontoyaml', data)
            .then(response => {
        ...
        <div className="detail-hero" style={{ 'minHeight': '320px', 'maxHeight': '320px' }}>
            ...
            <div className="detail-hero-content">
                <div className="detail-hero-content-heading">
                    <h1>JSON To YAML Generator
                    </h1>
                </div>
                <div className="detail-hero-content-des">
                    <p>Generate JSON To YAML with our generator tool. Preview the result and copy the generated code to your website.
                    </p>
                </div>
