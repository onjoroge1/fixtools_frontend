      ...
      <div className="detail-hero">
        ...
        <div className="detail-hero-content">
          ...
          <div className="detail-hero-content-des">
            <p>Generate CSS background with our CSS generator tool. Preview the result and copy the generated code to your website.</p>
          </div>
      ...
      <div className='screen'>
        ...
        <h1>Preview</h1>
          <div className='screen-preview-box'>
            <div style={{'background': `${color1}`}} className='screen-preview-box-sample'>
            </div>
          </div>
          <h1>Code</h1>
