            ...
            <div className="detail-hero">
                ...
                <div className="detail-hero-content">
                    ...
                    <div className="detail-hero-content-des">
                        <p>Generate HTML Range Input with our generator tool. Preview the result and copy the generated code to your website.
            ...
            <div className='screen'>
                <div className='screen-editor'>
                    ...
                    <div className='screen-editor-color' >
                        ...
                        <input type={'number'} placeholder={'Write value 1 , 5 etc'} onChange={(e) => setvalue(e.target.value)} />
                    </div>
                    <div className='screen-editor-color' >
                        <label>
                            Step
                        </label>
                        <input type={'number'} placeholder={'Write steps 1 , 5 etc'} onChange={(e) => setstep(e.target.value)} />
                    </div>
                    <div className='screen-editor-color' >
                        <label>
                            Minimum
                        </label>
                        <input type={'number'} placeholder={'Write steps 0 , 1 etc'} onChange={(e) => setmini(e.target.value)} />
                    </div>
                    <div className='screen-editor-color' >
                        <label>
                            Maximum
                        </label>
                        <input type={'number'} placeholder={'Write steps 10 , 100 etc'} onChange={(e) => setmax(e.target.value)} />
                    </div>
                    ...
                    <div className='screen-preview-box'>
                        <div className='screen-preview-box-sample' style={{ 'overflow': 'hidden' }}>
                            <div>
                                ...
                                <input type={'range'} value={value} step={step} min={mini} max={max} style={{ 'width': '200px' }} />
                            </div>
                        </div>
                    </div>
                    <h1>Code</h1>
