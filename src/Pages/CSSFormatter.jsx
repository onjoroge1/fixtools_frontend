    ...
    const handleSubmit = async (e) => {
        ...
        .then(async(response) => {
            if (response.data.valid === true) {
                try{
                    await axios.post('https://fixtoolupdateninenovember.herokuapp.com/api/beautycss',data).then(
                        response => {
        ...
        <div className="detail-hero" style={{ 'minHeight': '320px', 'maxHeight': '320px' }}>
            ...
            <div className="detail-hero-content">
                <div className="detail-hero-content-heading">
                    <h1>CSS Formatter Generator
                    </h1>
                </div>
                <div className="detail-hero-content-des">
                    <p>Generate CSS Formatter with our generator tool. Preview the result and copy the generated code to your website.
                    </p>
                </div>
