            ...
            <div className="detail-hero">
                ...
                <div className="detail-hero-content">
                    <div className="detail-hero-content-heading">
                        <h1>CSS Overflow Generator
                        </h1>
                    </div>
                    <div className="detail-hero-content-des">
                        <p> Generate CSS Overflow with our generator tool. Preview the result and copy the generated code to your website.
                        </p>
                    </div>
                ...
                <div className='screen-preview'>
                    ...
                    <div className='screen-preview-box'>
                        <div className='screen-preview-box-sample' style={{ 'overflow': 'hidden' }}>
                            <div style={{'width': '150px', 'height': '150px', 'background': 'skyblue','overflow': `${value}`,'overflowX': `${value}`,'overflowY': `${value}` }}>
                    ...
                    <div className='screen-preview-code'>
                        <code className='element-code'>{type}: {value};</code>
