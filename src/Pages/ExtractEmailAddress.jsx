...
export default function ExtractEmailAddress(){
    ...
    useEffect(() => {
        document.title = "Extract emailAddress from strings, words or paragraphs";
    }, []);
        ...
        <div className="detail-hero" style={{ 'minHeight': '320px', 'maxHeight': '320px' }}>
            ...
            <div className="detail-hero-content">
                <div className="detail-hero-content-heading">
                    <h1>Extract EmailAddress From Text
                    </h1>
                </div>
                <div className="detail-hero-content-des">
                    <p>This tool makes it fast and easy to find all the email addresses in your text. 
                    </p>
                </div>
...
<div className="text-body">
          ...
          <ul>
            ...
            <li>Improved accuracy: it's easy to miss email addresses when you're manually scanning through text, especially if the text is long or poorly-formatted. An email extraction tool, on the other hand, can accurately identify even the most difficult-to-find email addresses, ensuring that you don't miss any important contacts.</li>
            <li>Customization: some email extraction tools allow you to customize the regular expressions that they use to search for email addresses. This can be useful if you need to extract email addresses that have a specific format, or if you need to exclude certain types of email addresses (such as those with a certain domain name).</li>
          </ul>
          <p>An email extraction tool can be a valuable tool for anyone who needs to quickly and accurately extract email addresses from text. These tools use regular expressions and advanced algorithms to identify email</p>
