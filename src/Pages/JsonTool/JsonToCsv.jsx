...
export default function JsonToCsv() {
    ...
    const handleSubmit = async (e) => {
        ...
        await axios.post('https://fixtoolupdateninenovember.herokuapp.com/api/jsontocsv', data)
            .then(response => {
        ...
        <div className="detail-hero" style={{ 'minHeight': '320px', 'maxHeight': '320px' }}>
            ...
            <div className="detail-hero-content">
                <div className="detail-hero-content-heading">
                    <h1>JSON To CSV Generator
                    </h1>
                </div>
                <div className="detail-hero-content-des">
                    <p>Generate JSON To CSV with our generator tool. Preview the result and copy the generated code to your website.
                    </p>
                </div>
