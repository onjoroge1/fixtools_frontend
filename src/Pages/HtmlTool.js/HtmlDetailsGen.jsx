            ...
            <div className="detail-hero">
                ...
                <div className="detail-hero-content">
                    <div className="detail-hero-content-heading">
                        <h1>HTML Details Generator

                        </h1>
                    </div>
                    <div className="detail-hero-content-des">
                        <p>Generate HTML Details with our generator tool. Preview the result and copy the generated code to your website.
                ...
                <div className='screen-editor'>
                    ...
                    <div className='screen-editor-color checkbox' style={{ 'flexDirection': 'row' }}>
                        <label style={{ 'align-items': 'flex-end' }}>
                            <input type={'checkbox'} onChange={(e) => setrequired(e.target.checked ? 'open' : '')} style={{ 'height': '20px', 'width': '25px' }} />
                            Open by Default
                        </label>
                    </div>
