...
export const WordSpacing = () => {
    ...
    useEffect(() => {
        document.title="CSS Word Spacing Generator";
      }, []);
            ...
            <div className="detail-hero">
                ...
                <div className="detail-hero-content">
                    <div className="detail-hero-content-heading">
                        <h1>CSS Word Spacing Generator
                        </h1>
                    </div>
                    <div className="detail-hero-content-des">
                        <p>Generate CSS Word Spacing with our generator tool. Preview the result and copy the generated code to your website.
                        </p>
                    </div>
                ...
                <div className='screen-preview'>
                    ...
                    <div className='screen-preview-box'>
                        <div className='screen-preview-box-sample' style={{ 'overflow': 'hidden' }}>
                            <p style={{ 'word-spacing': `${value}px`, 'width': '70%', 'height': '150px', }} >
