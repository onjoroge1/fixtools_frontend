...
export default function MinifyHTML() {
    ...
    const handleSubmit = async (e) => {
        ...
        var rep = formdata.replace(/\<\!--\s*?[^\s?\[][\s\S]*?--\>/g, '').replace(/\>\s*\</g, '><')
        console.log(rep)
        setResult(rep)
        toast.success('Success!', {
            position: "top-right",
        ...
        <div className="detail-hero">
            ...
            <div className="detail-hero-content">
                <div className="detail-hero-content-heading">
                    <h1>HTML Minify Generator
                    </h1>
                </div>
                <div className="detail-hero-content-des">
                    <p>Generate HTML Minify with our generator tool. Preview the result and copy the generated code to your website.
                    </p>
                </div>
