        ...
        <div className="detail-hero" style={{ 'minHeight': '320px', 'maxHeight': '320px' }}>
            ...
            <div className="detail-hero-content">
                <div className="detail-hero-content-heading">
                    <h1>JSON Minify Generator
                    </h1>
                </div>
                <div className="detail-hero-content-des">
                    <p>Generate JSON Minify with our generator tool. Preview the result and copy the generated code to your website.
                    </p>
                </div>
        ...
        <div className="container d-flex align-items-center justify-content-center row col-md-8">
            ...
            <div className="col-md-12 col-lg-12 offset-lg-6">
                ...
                <div className="form-group">
                    ...
                    <textarea className="form-control element-code" rows="15" id="input-comment" value={result1}
