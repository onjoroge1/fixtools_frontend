            ...
            <div className="detail-hero">
                ...
                <div className="detail-hero-content">
                    ...
                    <div className="detail-hero-content-des">
                        <p>Generate HTML URL Input with our generator tool. Preview the result and copy the generated code to your website.
            ...
            <div className='screen'>
                <div className='screen-editor'>
                    ...
                    <div className='screen-editor-color' >
                        ...
                        <input type={'text'} placeholder={pattern} onChange={(e) => setPattern
                            (e.target.value)} />
                    </div>
                    <div className='screen-editor-color' >
                        <label>
                    ...
                    <div className='screen-preview-box'>
                        <div className='screen-preview-box-sample' style={{ 'overflow': 'hidden' }}>
                            <div>
                                ...
                                <input type={'url'} pattern={pattern} size={size} required={required} placeholder={value} />
                            </div>
                        </div>
                    </div>
                    <h1>Code</h1>
