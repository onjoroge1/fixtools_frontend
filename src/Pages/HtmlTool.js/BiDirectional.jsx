...
export const BiDirectional = () => {
    ...
    useEffect(() => {
        document.title="HTML Bi Directional Generator";
      }, []);
            ...
            <div className="detail-hero">
                ...
                <div className="detail-hero-content">
                    <div className="detail-hero-content-heading">
                        <h1>HTML Bi Directional Generator

                        </h1>
                    </div>
                    <div className="detail-hero-content-des">
                        <p>Generate HTML Bi Directional with our generator tool. Preview the result and copy the generated code to your website.
                        </p>
                    </div>
